  ...
  <div className="abt_container">
    ...
    <div className="about-me">
      ...
      <p>
        ...
        the way that user can create a new task, can edit and save it again,
        user can check it as completed
        or delete the tasks.
        <br />
        All tasks are stored locally using localStorage.
        <br />
        It is created using React(components, Hooks, Router) and SASS.
      </p>
